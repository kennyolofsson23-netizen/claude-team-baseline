...
description: FastAPI conventions — dependency injection, pydantic models, async patterns, testing. Auto-invoked when touching src/main.py, routes/, or when the prompt mentions FastAPI / uvicorn / pydantic.
---
