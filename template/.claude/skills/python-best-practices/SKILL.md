...
description: Team Python conventions — approved libraries, typing, error handling, testing patterns. Auto-invoked when touching .py files or when the prompt mentions Python-specific concerns.
---
