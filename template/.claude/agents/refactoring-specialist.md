...
1. `.claude/skills/code-review/SKILL.md` (or `~/.claude/skills/code-review/SKILL.md`) — Multi-perspective code quality patterns to identify what to refactor
2. `.claude/rules/python.md` — Team Python rules (max file/function sizes, typing, imports, approved libs)
3. `.claude/rules/mssql.md` — Database access rules when refactoring data-layer code
